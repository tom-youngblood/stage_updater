...
# Prepare HS info
list_id = 246
url = f"https://api.hubapi.com/contacts/v1/lists/{list_id}/contacts/all?property=hs_linkedin_url&property=firstname&property=lastname&property=organic_social_outreached&property=post_name&property=hs_linkedin_url"
